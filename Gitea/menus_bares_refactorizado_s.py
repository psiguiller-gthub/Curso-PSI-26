...
class Bar:
    ...
    def __init__(self, nombre, menus=None): # Funciones dentro de una clase se llaman métodos, y el primer parámetro de estos métodos es siempre self, 
                                            # que hace referencia a la instancia actual del objeto.
        """
        ...
        """
        self.nombre = nombre
        self.menus = menus if menus is not None else [] # si hay menús proporcionados, los asigna; de lo contrario, inicializa una lista vacía. 
                                                        # Operador ternario para evitar problemas con listas mutables como valores predeterminados.
    def imprimir_menus(self):
        ...
        for i, menu in enumerate(self.menus): # Utiliza la función enumerate para obtener tanto el índice (i) como el valor (menu) de cada elemento en la lista de menús.
            print(f"Menu {i}: {menu}")
        print("=" * 50)
